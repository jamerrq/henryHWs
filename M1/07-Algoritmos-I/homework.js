...
function bubbleSort(array) {
    ...
    // Más información en: https://www.geeksforgeeks.org/bubble-sort/
...
function insertionSort(array) {
    ...
    // Más información en https://www.geeksforgeeks.org/insertion-sort/
    // Longitud del arreglo
    let n = array.length;
    // Por cada elemento del arreglo, empezando por el segundo:
    for(let i = 1; i < n; ++i){
        let j = i;
        // Dependiendo qué tan mayor sea el elemento actual, se manda
        // hacia atrás las posiciones necesarias en el arreglo
